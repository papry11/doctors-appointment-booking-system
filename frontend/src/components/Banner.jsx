  ...
  return (
      <div className='flex bg-teal-600 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
          ...
          <div className='flex-1 py-8 sm:py-10 md:py-16 lg-py-24 lg:pl-5'>
              ...
              <button onClick={() => { navigate('/login'); scrollTo(0,0)}} className="inline-flex items-center gap-2 bg-white text-gray-600 mt-4 hover:scale-105 transition-all duration-300 font-medium px-5 py-2.5 rounded-full w-max cursor-pointer">Create Acount</button>
          </div>
          {/* right side */}
