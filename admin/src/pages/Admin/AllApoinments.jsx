...
const AllAppointments = () => {
  const { aToken, appointments, getAllAppontments, cancelappointment } =
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-3 sm:p-6 bg-gray-50 min-h-screen">
      <h1 className="text-lg sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-6">
        All Appointments
      </h1>
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        {appointments && appointments.length > 0 ? (
          appointments.map((item, index) => (
            <div
              key={index}
              className="border-b border-gray-200 px-3 sm:px-6 py-4 hover:bg-gray-50 transition-colors duration-150"
            >
              {/* Desktop View */}
              ...
              {/* Mobile View */}
              <div className="md:hidden flex flex-col gap-3 bg-white rounded-md shadow-sm p-3 border border-gray-100">
                {/* Patient */}
